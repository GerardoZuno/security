...
const EmergencyContact1 = ({user}: Props) => {
  ...
  const onSubmit = async (data: any) => {
    ...
    const updateProfile = {
      ...
      contactThree: {
        name: data.fullName3 || '',
        telephone: data.phone3.toString() || '',
        relationship: data.relationShip3 || '',
      },
    };
  ...
  return (
    <>
      <View style={styles.buttonWrapper}>
        <Text style={styles.title}>Contacto 3</Text>
        <Input
          label="Nombre"
          showLabel={false}
          control={control}
        ...
        <ListCollapsible
          tittle="Parentesco"
          list={parentesco}
          isCollapsed={contact3}
          setIsCollapsed={setContact3}
          setValue={setValue}
          name={'relationShip3'}
        />
      </View>
